      ...
      <div className="meeting-container">
            ...
            <span className="user-badge">
              {user.avatar ? (
                <img
                  src={user.avatar}
                  alt={user.name}
                  style={{ width: '20px', height: '20px', borderRadius: '999px', marginRight: '6px' }}
                />
              ) : (
        ...
        <div className="meeting-content">
          <div className="video-section">
            <VideoCall
              ...
              onCleanup={(cleanupFn) => {
                videoCallCleanupRef.current = cleanupFn;
              }}
        ...
        {showSettings && (
          <Settings
            ...
            onSettingsChange={(settings) => setAppliedSettings(settings || {})}
          />
        )}
        ...
        {showMissedSpeech && (
          <MissedSpeech
            ...
            onClose={() => setShowMissedSpeech(false)}
